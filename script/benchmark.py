...
Run from repo root: python script/benchmark.py
"""
...
def get_val_map(model_path, data_yaml=r"data\data.yaml"):
    model = YOLO(model_path)
...
if __name__ == "__main__":
    ...
    results = {}
    for label, path in [("FP32", r"model\best.onnx"),
                          ("FP16", r"model\best_quantized.onnx")]:
        print(f"--- {label} ({path}) ---")
